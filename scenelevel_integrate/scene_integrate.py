...
# Usage example
integrate_qa_with_scene_level_data("../sceneQ_collect/AnotherMissOhSceneQA_train.json", "AnotherMissOh_train_scene_recon.json", "AnotherMissOhQA_train_epsc.json")
