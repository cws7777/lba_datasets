...
def merge_data(updated_file, test_set_file):
    ...
    for updated_entry in updated_data:
        ...
        if test_entry:
            ...
            new_entry = {
                'vid': vid,
                'answers': [updated_entry['answer']],
                'que': updated_entry['question'],
...
for i in range(16, 19):
    ...
    test_set_filename = "../originals/AnotherMissOhQA_test_set.json"
    new_filename = "./AnotherMissOhQA_test_set_scnew.json"
