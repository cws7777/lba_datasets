...
txt_file_path = './additional_qas/AnotherMissOh15_sceneaddQA_20240522.txt'
json_file_path = '../originals/AnotherMissOhQA_val_set.json'
output_file_path = './AnotherMissOhQA15_updated.json'
...
def parse_txt_file(file_path):
    ...
    for line in lines:
        if line.startswith("AnotherMissOh15"):
