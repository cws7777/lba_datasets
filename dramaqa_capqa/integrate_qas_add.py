...
txt_file_path = './additional_qas/AnotherMissOh17_sceneaddQA_20240522.txt'
json_file_path = '../originals/AnotherMissOhQA_test_set.json'
output_file_path = './AnotherMissOhQA17_updated.json'
...
def parse_txt_file(file_path):
    ...
    for line in lines:
        if line.startswith("AnotherMissOh17"):
