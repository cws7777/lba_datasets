...
# Load text data
with open('./additional_qas_shot/shotsAnotherMissOh02_shotaddQA_20240618.txt', 'r', encoding='utf-8') as text_file:
...
with open('./AnotherMissOh02_updated_shot.json', 'w', encoding='utf-8') as output_file:
