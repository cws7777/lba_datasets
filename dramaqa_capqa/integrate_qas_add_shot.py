...
# Load JSON data
with open('../originals/AnotherMissOhQA_test_set.json', 'r', encoding='utf-8') as json_file:
    json_data = json.load(json_file)

# Load text data
with open('./additional_qas_shot/shotsAnotherMissOh17_shotaddQA_20240618.txt', 'r', encoding='utf-8') as text_file:
...
with open('./AnotherMissOh17_updated_shot.json', 'w', encoding='utf-8') as output_file:
